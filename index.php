                    ...
                    <div class="position-relative w-100 mt-3">
                        <form action="" method="post">
                            <div class="d-flex py-3">
                                <input name="nom" id="nom" class="form-control border-0 rounded-pill w-100 ps-4 pe-5 me-2" type="text" placeholder="Entrez votre nom" style="height: 35px;" required="" wfd-id="id0">
                                <input name="prenom" id="prenom" class="form-control border-0 rounded-pill w-100 ps-4 pe-5" type="text" placeholder="Entrez votre prenom" style="height: 35px;" required="" wfd-id="id0">
                            </div>
                            <div class="d-flex py-3">
                                <input name="user_email" id="user_email" class="form-control border-0 rounded-pill w-100 ps-4 pe-5 me-2" type="email" placeholder="Entrez votre Email" style="height: 35px;" required="" wfd-id="id0">
                                <input name="phone" id="phone" class="form-control border-0 rounded-pill w-100 ps-4 pe-5" type="phone" placeholder="Entrez votre Whatsapp" style="height: 35px;" required="" wfd-id="id0">
                            </div>
                            <center> <button type="button" id="btn" name="submit" class="btn btn-secondary rounded-pill" style="background: grey;font-weight: bold;text-transform: uppercase;">Enregistrer</button></center>
                        </form>
                        ...
                        <?php
                            ...
                            //     include("./admin/sender.php");
                            //     send_mail($_POST['user_email'], $_POST['nom'], $_POST['prenom'], "SOUSCRIPTION", "Merci d'avoir souscris au newsletters");
                            // }
                    ...
                    <div class="info-container d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="info-item d-flex">
                            ...
                            <div>
                                ...
                                <p class="text-white">info@cinef-bj.com</p>
                            </div>
                        </div><!-- End Info Item -->
                ...
                "click": function () {
                    $.ajax({
                        ...
                        success: function (data) {
                            $("form center").html("<marquee class='text-white fw-bolder'>" + data + "</marquee>")
                            return false;
                        },
                    })
                }
