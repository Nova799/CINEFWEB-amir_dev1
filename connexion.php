                ...
                <div class="card-body p-4 text-black">
                  ...
                  <form method="post">
                    ...
                    <div class="form-outline mb-4 input">
                      <input type="email" placeholder="Email" id="form2Example17" class="form-control form-control-lg" style="border-bottom: 1px solid black !important" name="mail">
                      <!-- <label class="form-label form-control" for="form2Example17">Email address</label> -->
                    </div>

                    <div class="form-outline mb-4">
                      <input type="password" id="form2Example27" class="form-control form-control-lg" style="border-bottom: 1px solid black !important;" name='pass'>
...
if (isset($_POST['sub']) && isset($_POST['pass']) && isset($_POST['mail']) && $_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if ($result->num_rows > 0) {
    ...
    header('Location: admin/star-admin2-free-admin-template-main/template/index.html');
  }
}
