      ...
      <div class="navbar-menu-wrapper d-flex align-items-top">
        ...
        <ul class="navbar-nav ms-auto">
         ...
         <!--  <li class="nav-item d-none d-lg-block">
          ...
          <!-- <li class="nav-item dropdown d-lg-block user-dropdown d-none">
                      ...
                      <div class="col-sm-12">
                        <div class="statistics-details d-flex align-items-center justify-content-between">
                          <div class='bg-success text-light p-4 rounded'>
                            <?php include('../../config/conn.php'); $conn = conn(); ?> 
                            <p class="statistics-title text-light">Total des utilisateurs</p>
                            <h3 class="rate-percentage text-center text-light"><?php  
              ...
              <input type="search" id="searchInput" placeholder="Recherche..." class='form-control form-control-sm'>
                ...
                <!-- <button id="call" name="searchInput">
                  envoer
                                    ...
                                    ?>
                                      <tr>
                                                      ...
                                                      <td class='text-center pointer d-flex'>
                                                        <a href="../../traitement.php?id=<?= $row["id"] ?>" class='text-secondary' target='_blank'><h2 class="mdi mdi-eye"></h2></a>
                                                        <a href="../../traitement.php?id=<?= $row["id"] ?>" class='text-secondary' target='_blank'><h2 class="mdi mdi-pen"></h2></a>
                                                        <a href="../../traitement.php?id=<?= $row["id"] ?>" class='text-secondary' target='_blank'><h2 class="mdi mdi-send"></h2></a>
                              ...
                              <tr>
                                <td colspan="5">
                                  <a class='btn btn-secondary float-start' href='?page=<?php if (isset($_GET['page'])  ) {echo "".(intval($_GET['page']) - 1)."" ;}else{echo '0';} ?>'>Pr&eacute;c&eacute;dent</a>
                                  <a class='btn btn-primary text-white float-end' href='?page=<?php if (isset($_GET['page'])) {echo "".(intval($_GET['page']) + 1)."" ;}else{echo '1';} ?>'>Suivant</a>
                                </td>
                              </tr>
                                                  </tbody>
                                                </table>
