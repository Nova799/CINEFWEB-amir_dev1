          ...
          <div class="bg-light px-0 pt-4 pb-0 mt-3 mb-3 p-3 ">
            ...
            <form id="msform" action="./traitement.php" novalidate method="post" style="background-color:#f5f8f7 !important ;">
              ...
              <fieldset>
                <div class="form-card">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="formation" autocomplete="on" required>
                      <optgroup>
                        <?php
              ...
              <fieldset>
                ...
                </div> <input type="submit" name="next_finish" class="submit action-button" value="Aperçu" />
